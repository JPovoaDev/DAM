...
import com.example.dogviewer.viewmodel.DogViewModel
import com.example.dogviewer.viewmodel.DogViewModelFactory
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 2. Setup ViewModel using the GLOBAL shared repository from ApiClient
    ...
    private fun refreshFavoritesCount() {
        val count = ApiClient.dogRepository.getFavorites().size
