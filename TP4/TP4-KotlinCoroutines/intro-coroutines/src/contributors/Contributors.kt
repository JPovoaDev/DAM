...
interface Contributors: CoroutineScope {
        ...
        when (getSelectedVariant()) {
            ...
            CHANNELS -> {  // Performing requests concurrently and showing progress
                ...
                launch(Dispatchers.Default) {
                    ...
                    for (result in progressChannel) {
                        withContext(Dispatchers.Main) {
                            updateResults(result.first, startTime, result.second)
                        }
                    }
                }.setUpCancellation()
            }
    ...
    private fun clearResults() {
        ...
        updateLoadingStatus(LoadingStateData(status = LoadingStatus.IN_PROGRESS))
    ...
    private fun updateResults(
        ...
        updateLoadingStatus(LoadingStateData(
            status = status,
            startTime = startTime,
